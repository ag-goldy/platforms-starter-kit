-- Filtered subset of drizzle/0026_new_features_phase5.sql
-- Omitted: CREATE TABLE time_entries + 5 indexes (table exists in production with different schema)
-- Applied: 43 of 49 statements
...
-- Time Tracking
-- ============================================
-- OMITTED: CREATE TABLE time_entries (exists in production with different schema)
-- OMITTED: 5 time_entries indexes (idx_time_entries_ticket, idx_time_entries_user, idx_time_entries_org, idx_time_entries_date, idx_time_entries_billable)
...
-- Trigger on time_entries is safe: table exists but trigger does not
