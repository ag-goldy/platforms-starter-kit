          ...
          <CardContent className="space-y-2 text-sm text-gray-600">
            <div className="space-y-1">
              <div className="flex items-center justify-between font-medium">
                ...
                <span>
                  Q:{jobQueueStats.SEND_EMAIL.queue} P:
                  {jobQueueStats.SEND_EMAIL.processing} F:
                  {jobQueueStats.SEND_EMAIL.failed}
                </span>
              </div>
              <div className="flex items-center justify-between font-medium">
                <span>Export Jobs</span>
                <span>
                  Q:{jobQueueStats.GENERATE_EXPORT.queue} P:
                  {jobQueueStats.GENERATE_EXPORT.processing} F:
                  {jobQueueStats.GENERATE_EXPORT.failed}
                </span>
              </div>
              <div className="flex items-center justify-between font-medium">
                <span>Org Export Jobs</span>
                <span>
                  Q:{jobQueueStats.GENERATE_ORG_EXPORT.queue} P:
                  {jobQueueStats.GENERATE_ORG_EXPORT.processing} F:
                  {jobQueueStats.GENERATE_ORG_EXPORT.failed}
                </span>
              </div>
