          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900">
                  {
                    teamMembers.filter((m) => m.role === "CUSTOMER_ADMIN")
                      .length
                  }
                </p>
      ...
      <div className="flex items-center justify-center py-12">
        <Card className="w-full max-w-md border-gray-100 rounded-2xl shadow-sm">
          ...
          <CardContent className="pt-0">
            <Link
              href="/login"
              className="inline-flex items-center justify-center w-full bg-black hover:bg-gray-800 text-white h-11 rounded-xl font-medium transition-colors"
            >
              Sign in to Continue
            </Link>
          </CardContent>
