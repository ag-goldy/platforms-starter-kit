...
export function InfrastructureSlideOver({ org }: InfrastructureSlideOverProps) {
  ...
  const [integration, setIntegration] = useState<ZabbixIntegration | null>(
    null,
  );
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-stone-100">
          ...
          <div className="flex items-start gap-4">
            <div
              className={`w-12 h-12 rounded-xl ${getStatusBg(status)} flex items-center justify-center`}
            >
                  ...
                  .map((trigger) => (
                    ...
                    >
                      ...
                      <p className="text-xs text-stone-500 mt-1">
                        Since{" "}
                        {new Date(
                          parseInt(trigger.lastchange) * 1000,
                        ).toLocaleString()}
                      </p>
                    </div>
                  ))}
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-sm text-stone-500 max-w-sm mb-6">
            Connect your Zabbix monitoring system to view real-time
            infrastructure status, alerts, and performance metrics.
          </p>
          <a
      ...
      <div className="px-6 py-4 border-b border-stone-100">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-stone-500">
              {stats.total} hosts • {stats.online} online • {stats.issues}{" "}
              issues • {stats.offline} offline
            </p>
          </div>
          <div className="flex items-center gap-2">
            <button
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {host.ip && (
                      <p className="text-[10px] text-stone-400">{host.ip}</p>
                    )}
                  </div>
                  <div className="text-right">
                    ...
                    {host.triggers?.some((t) => t.value === "1") && (
                      <p className="text-[10px] text-red-600">
                        {host.triggers.filter((t) => t.value === "1").length}{" "}
                        alerts
                      </p>
                    )}
                  </div>
