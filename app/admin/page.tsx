...
function tenantStatus(org: typeof organizations.$inferSelect) {
  ...
  if (org.deletionScheduledAt)
    return <Badge variant="outline">Delete scheduled</Badge>;
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400">
            Manage tenants, platform health, jobs, feature flags, and
            cross-tenant audit.
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="border-zinc-800 bg-zinc-900 text-zinc-100">
          <CardHeader>
            <CardTitle className="text-sm text-zinc-400">Suspended</CardTitle>
          </CardHeader>
          <CardContent className="text-3xl font-semibold">
            {suspendedTenants}
          </CardContent>
        ...
        <Card className="border-zinc-800 bg-zinc-900 text-zinc-100">
          ...
          <CardContent className="text-3xl font-semibold">
            {Number(totalTickets[0]?.count || 0)} /{" "}
            {Number(failedJobRows[0]?.count || 0)}
          </CardContent>
        </Card>
      </div>
