  ...
  return (
    <Card>
      <CardHeader>
          ...
          <Dialog open={isAdding} onOpenChange={setIsAdding}>
            ...
            <DialogContent className="max-w-lg">
              ...
              <div className="space-y-4 pt-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="fact">
                        Fact - Known information about the org
                      </SelectItem>
                      <SelectItem value="preference">
                        Preference - Customer preferences
                      </SelectItem>
                      <SelectItem value="policy">
                        Policy - Business rules or policies
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <Button
                  onClick={handleAdd}
                  disabled={isLoading || !newMemory.content.trim()}
                  className="w-full"
                >
                  {isLoading ? (
        ...
        <CardDescription>
          Memories help the AI understand your organization better. They are
          included in every AI conversation.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {memories.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            ...
            <p>
              No memories yet. Add some to help the AI understand your
              organization.
            </p>
          </div>
        ) : (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Button
                          size="sm"
                          onClick={() =>
                            handleUpdate(memory.id, { content: memory.content })
                          }
                          disabled={isLoading}
                        >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <Badge
                            className={memoryTypeColors[memory.memoryType]}
                          >
