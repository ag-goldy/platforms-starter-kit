...
export function OrganizationSLAPolicy({
  orgId,
  currentPolicy,
}: OrganizationSLAPolicyProps) {
        ...
        {!isEditing && hasAnyValue && (
          <div className="space-y-4">
            ...
            {(["P1", "P2", "P3", "P4"] as const).map((priority) => {
              const responseKey =
                `slaResponseHours${priority}` as keyof typeof policy;
              const resolutionKey =
                `slaResolutionHours${priority}` as keyof typeof policy;
              ...
              return (
                ...
                >
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setPolicy({ ...policy, [responseKey]: e.target.value })
                    }
                  />
                  <Input
                    type="number"
                    ...
                    onChange={(e) =>
                      setPolicy({ ...policy, [resolutionKey]: e.target.value })
                    }
                  />
                </div>
              );
