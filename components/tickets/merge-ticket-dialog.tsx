...
import {
  mergeTicketsAction,
  getMergeableTicketsAction,
} from "@/app/app/actions/merges";
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Merge ticket <strong>{ticketKey}</strong> into another ticket. All
            comments and tags will be moved to the target ticket.
          </p>
          ...
          {mergeableTickets.length === 0 ? (
            ...
            <>
              ...
              <div className="rounded-md bg-yellow-50 border border-yellow-200 p-3 text-sm text-yellow-800">
                ...
                source ticket will be marked as merged and all its content will
                be moved to the target ticket.
              </div>
