...
async function fix() {
  ...
  try {
    ...
    console.error("✗ ticket_comments:", e);
  }
  ...
  try {
    ...
    console.error("✗ canned_responses:", e);
  }
  ...
  try {
    ...
    console.error("✗ automation_rules_executions:", e);
  }
  ...
  try {
    ...
    console.error("✗ csat_responses:", e);
  }
  ...
  try {
    ...
    console.error("✗ incident_updates:", e);
  }
  ...
  try {
    ...
    console.error("✗ ticket_assignment_rules:", e);
  }
  ...
  try {
    ...
    console.error("✗ satisfaction_ratings:", e);
  }
  ...
  try {
    ...
    console.error("✗ dashboard_widgets:", e);
  }
  ...
  try {
    ...
    console.error("✗ scheduled_exports:", e);
  }
  ...
  try {
    ...
    console.error("✗ retention_policies:", e);
  }
