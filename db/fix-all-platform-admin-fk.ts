...
async function fix() {
  ...
  try {
    ...
    console.error("✗ user_invitations:", e);
  }
  ...
  try {
    ...
    console.error("✗ password_reset_tokens:", e);
  }
  ...
  try {
    ...
    console.error("✗ internal_group_memberships:", e);
  }
  ...
  try {
    ...
    console.error("✗ export_requests:", e);
  }
  ...
  try {
    ...
    console.error("✗ notice_acknowledgments:", e);
  }
  ...
  try {
    ...
    console.error("✗ notification_preferences:", e);
  }
  ...
  try {
    ...
    console.error("✗ push_subscriptions:", e);
  }
  ...
  try {
    ...
    console.error("✗ kb_article_feedback:", e);
  }
  ...
  try {
    ...
    console.error("✗ kb_article_versions:", e);
  }
  ...
  try {
    ...
    console.error("✗ zabbix_configs:", e);
  }
